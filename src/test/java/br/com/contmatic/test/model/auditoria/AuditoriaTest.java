...
public class AuditoriaTest {
	...
	@Test
	void deve_aceitar_campo_nome_criador_valido() {
		auditoria.setNomeCriador("Tiago");
		assertEquals("Tiago", auditoria.getNomeCriador());
	}
	
	@Test
	void nao_deve_aceitar_campo_nome_criador_nulo() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setNomeCriador(null));
		assertEquals(erro.getMessage(), NOME_CRIADOR_OBRIGATORIO );
	}
	
	@Test
	void nao_deve_aceitar_campo_nome_criador_vazio() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setNomeCriador(""));
		assertEquals(erro.getMessage(), NOME_CRIADOR_SEM_ESPAÇO_BRANCO );
	}
	
	@Test
	void nao_deve_aceitar_campo_nome_criador_menor_que_5_caracteres() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_campo_nome_criador_mais_que_10_caracteres() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_caracteres_repetidos_no_campo_nome_do_criador() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void deve_aceitar_campo_nome_do_editor_valido() {
		auditoria.setNomeEditor("Tiago");
		assertThat("Tiago", equalTo(auditoria.getNomeEditor()));	
	}
	
	@Test
	void nao_deve_aceitar_nome_editor_nulo() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_nome_editor_vazio() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_nome_editor_menor_que_5_caracteres() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_nome_editor_mais_que_10_caracteres() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_caracteres_repetidos_no_campo_nome_do_editor() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void deve_aceitar_data_hora_criacao_valida() {
		//Auditoria auditoria = new Auditoria();
		//ZoneId fusoHorarioSaoPaulo = ZoneId.of("America/Sao_Paulo");
		//ZonedDateTime dataHoraEsperada = ZonedDateTime.of(LocalDate.now(),LocalTime.now(),ZoneId.of("America/Sao_Paulo"));
		ZonedDateTime dataHoraEsperada = ZonedDateTime.now();
		auditoria.setDataHoraCriacao(dataHoraEsperada);
		//System.out.println(dataHoraEsperada);
		assertEquals(auditoria.getDataHoraCriacao(),dataHoraEsperada);
	}
	
	@Test
	void nao_deve_aceitar_data_hora_criacao_nulo() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_data_hora_criacao_diferente_do_horario_atual() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void deve_aceitar_data_hora_alteracao_valida() {
	...
	@Test
	void nao_deve_aceitar_data_hora_alteracao_nulo() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_data_hora_maior_alteracao_diferente() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	@Test
	void nao_deve_aceitar_data_hora_menor_alteracao_diferente() {
		IllegalArgumentException erro = assertThrows(IllegalArgumentException.class,
	...
	void deve_retornar_verdadeiro_para_o_toString() {
		...
		assertEquals("Auditoria [nomeCriador=null, nomeEditor=null, dataHoraCriacao=null, dataHoraAlteracao=null]",auditoria.toString());
	}
	
	  @Test
	    @Timeout(value = 100, unit = TimeUnit.MILLISECONDS) // Limite de 100 milissegundos
	    public void teste_com_timeout_passando() throws InterruptedException {
	        // Simula uma operação que leva algum tempo
	        Thread.sleep(95); // Dorme por 50 milissegundos
	        assertTrue(true); // O teste passa se terminar dentro do tempo
	    }//TODO pedir explicação para o victor
