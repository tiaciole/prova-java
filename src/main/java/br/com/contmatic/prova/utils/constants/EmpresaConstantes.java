...
public final class EmpresaConstantes {
	...
	public static final String O_CAMPO_DATA_CRIACAO_NAO_PODE_SER_NULO = "O campo Data de criação da empresa é obrigatorio";
	
	public static final String O_CAMPO_DATA_CRIACAO_NAO_PODE_SER_POSTERIOR_AO_DIA_ATUAL = "A Data de criação não pode ser posterior ao dia atual.";
	
	public static final String O_CAMPO_RAZAO_SOCIAL_NAO_PODE_SER_NULO = "O campo Razão Social é de preenchimento obrigatorio";
	
	public static final String O_CAMPO_RAZAO_SOCIAL_NAO_PODE_SER_VAZIO = "O campo é de preenchimento obrigatorio";
	
	public static final String O_CAMPO_RAZAO_SOCIAL_DEVE_TER_O_MINIMO_DE_3_CARACTERES = "O campo Razão Social deve conter ao menos 3 caracteres";
	
	public static final String O_CAMPO_RAZAO_SOCIAL_DEVE_TER_MAXIMO_DE_30_CARACTERES = "O tamanho máximo do campo Razão Social é de 30 caracteres";
	
	public static final String O_STATUS_E_OBRIGATORIO = "O status e´obrigatorio";
	
	public static final String NOME_COM_MAIS_DE_30_CARACTERES = "TR4dgf65914d9v1d9v198dv978 1s98d7";
	
	public static final String O_CAMPO_DATA_CRIACAO_NAO_PODE_SER_ANTES_01_01_1446 = "A data não pode ser anterior a 01/01/1446";
	...
	public static final Integer TAMANHO_4 = 4;
	
	public static final Integer TAMANHO_30 = 30;
